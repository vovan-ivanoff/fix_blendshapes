...
for _ in os.listdir(args.src+"\\AnimatorController\\"): nfixer.file_fix(args.src+"\\AnimatorController\\"+_)
for _ in os.listdir(args.src+"\\MonoBehaviour\\"): nfixer.file_fix(args.src+"\\MonoBehaviour\\"+_)
for _ in os.listdir(args.src+"\\AnimationClip\\"): nfixer.fix_anim(args.src+"\\AnimationClip\\"+_)
